...
<div class="content-section">
    ...
    <div style="background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); padding: 2rem; border-radius: 16px; margin: 2rem 0; border-left: 4px solid #f59e0b; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
        ...
        <p>
            ...
            air temperature create forces that produce motion—a fundamental physics principle that applies 
            to many real-world applications including wind turbines, hot air balloons, and heating systems.
        </p>
    </div>
    ...
    <div class="page-nav">
        <span></span>
        <a href="purpose.php" class="btn">Next: Purpose →</a>
    </div>
</div>
