...
<div class="content-section">
    ...
    <p>
        Follow these step-by-step instructions to build your candle carousel and conduct the experiment. 
    ...
    <ol>
        ...
        <li>The skewer should extend 15-20 cm above the base</li>
    ...
    <ol>
        ...
        <li>Divide the circle into 6-8 equal sections by drawing lines from edge toward center</li>
        <li>Cut along the lines, stopping about 1-2 cm from the center</li>
        <li>Carefully bend each section at an angle of 30-40 degrees (measure with protractor)</li>
        <li>All blades should be bent in the same direction (clockwise or counterclockwise)</li>
    ...
    <ol>
        ...
        <li>Ensure the blades can spin freely without touching the skewer or wobbling</li>
    ...
    <ol>
        ...
        <li>Count the number of complete rotations in 1 minute</li>
    ...
    <ol>
        ...
        <li>Record all data in your data table</li>
    </ol>
    
    <div class="safety-notice">
        <h3>⚠️ Safety Precautions</h3>
        <p><strong>IMPORTANT:</strong> Always follow these safety guidelines:</p>
        <ul>
            <li>Conduct experiment on a non-flammable surface</li>
            <li>Keep paper and flammable materials away from candles</li>
            <li>Never leave burning candles unattended</li>
            <li>Have adult supervision at all times</li>
            <li>Keep hands away from the area above the flames (hot air can cause burns)</li>
            <li>Ensure the room has adequate ventilation</li>
            <li>Have a fire extinguisher or water nearby as a precaution</li>
            <li>Wait for candles to cool completely before handling</li>
        </ul>
    </div>
    ...
    <ul>
        ...
        <li>Wait the full 30 seconds after lighting candles before starting measurements</li>
        <li>Count complete rotations carefully—mark one blade to help track rotations</li>
        <li>Keep the room as still as possible (no fans, closed windows)</li>
        <li>Use fresh candles for each trial to ensure consistent flame size</li>
    </ul>
    
    <div class="page-nav">
        <a href="variables_materials.php" class="btn btn-secondary">← Previous: Variables & Materials</a>
        <a href="data_results.php" class="btn">Next: Data & Results →</a>
    </div>
</div>
