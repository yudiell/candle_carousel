<?php
$page_title = "Future Research & Bibliography";
$current_page = "future";
...
<div class="content-section">
    ...
    <p>
        ...
        are formatted according to APA (American Psychological Association) style.
    </p>
    
    <ul class="bibliography">
        <li>
            ChristKindl-Markt. (n.d.). <em>German candle pyramids and candle carousel history</em>. Retrieved from 
            https://www.christkindl-markt.com/blog/german-candle-pyramids-and-candle-carousel-history/
        </li>
        
        <li>
            Ingrid Science. (n.d.). <em>Candle convection pinwheel</em>. Retrieved from 
            https://www.ingridscience.ca/node/706
        </li>
        
        <li>
            Science Buddies. (2022, November 14). <em>Build a candle carousel</em>. Retrieved from 
        ...
        <li>
            Science Buddies Blog. (2021, December 6). <em>Merry science: Take a candle carousel for a spin</em>. 
            Retrieved from https://www.sciencebuddies.org/blog/merry-science-take-a-candle-carousel-for-a-spin
        </li>
        
        <li>
            Science Sparks. (2011). <em>Create a candle carousel</em>. Retrieved from 
            https://www.science-sparks.com/create-a-candle-carousel/
        </li>
        
        <li>
            STEAM Powered Family. (2024, April 7). <em>Candle carousel experiment - exploring physics</em>. 
            Retrieved from https://www.steampoweredfamily.com/candle-carousel-experiment/
        </li>
        
        <li>
            Wikipedia. (2024, October 21). <em>Christmas pyramid</em>. Retrieved from 
            https://en.wikipedia.org/wiki/Christmas_pyramid
        </li>
    </ul>
    
    <div style="background-color: #e3f2fd; padding: 1rem; margin: 2rem 0; border-left: 4px solid #2196F3; border-radius: 4px;">
        <p style="margin: 0;">
            <strong>Note on Citations:</strong> All web sources were accessed during the research phase of this project. 
            URLs were verified at the time of citation. For the most current information, please verify these links 
            are still active.
        </p>
    </div>
    
    <div class="page-nav">
        <a href="conclusion.php" class="btn btn-secondary">← Previous: Conclusion</a>
